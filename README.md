...
# ChatGPT Plays The Oregon Trail
...
* Allows ChatGPT to play through the classic game [The Oregon Trail (1978)](https://en.wikipedia.org/wiki/The_Oregon_Trail_(1971_video_game)).
...
* Clone the repo.
* The Oregon Trail can be installed in a number of ways and it depends on your system.
...
* Ensure The Oregon Trail command in <b>config.ini</b> is correct or update it for your specific install.
